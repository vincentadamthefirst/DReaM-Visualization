...
namespace Habrador_Computational_Geometry
{
    ...
    public struct MyQuaternion
    {
        ...
        {
            unityQuaternion = Quaternion.LookRotation(forward.ToVector3());
        }

        public MyQuaternion(MyVector3 forward, MyVector3 up)
        {
            unityQuaternion = Quaternion.LookRotation(forward.ToVector3(), up.ToVector3());
        }

        public MyQuaternion(Quaternion quaternion)
        {
            unityQuaternion = quaternion;
        }
