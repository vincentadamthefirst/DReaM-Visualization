...
namespace Habrador_Computational_Geometry
{
    ...
    public class HalfEdgeData3
    {
        ...
        {
            verts = new HashSet<HalfEdgeVertex3>();

            faces = new HashSet<HalfEdgeFace3>();

            edges = new HashSet<HalfEdge3>();
        }
    ...
    public class HalfEdgeVertex3
    {
        ...
        public HashSet<HalfEdge3> GetEdgesPointingToVertex(HalfEdgeData3 meshData)
        {
            ...
            HalfEdge3 currentEdge = edge.prevEdge;
            ...
            while (currentEdge != edge.prevEdge);
