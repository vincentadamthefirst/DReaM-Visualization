...
namespace Scenery_Rework.OpenDrive_Elements.Road.RoadGeometries {
    ...
    /// </summary>
    public class ParamPoly3Geometry : Scenery.RoadNetwork.RoadGeometries.RoadGeometry {
        ...
        public override Vector2 Evaluate(float s, float t) {
            ...
            while (k < s) {
                ...
                if (Math.Abs(deltaLength) < Tolerance) {
                    throw new Scenery.RoadNetwork.RoadGeometries.RoadGeometryGenerationException("ParamPoly3 generation could not be finished.");
                }
