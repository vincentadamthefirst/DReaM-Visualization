...
Shader "Universal Render Pipeline/Custom/TestMaskShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Tags{"RenderType" = "Opaque" "RenderPipeline" = "UniversalRenderPipeline" "IgnoreProjector" = "True" "Queue" = "Geometry-100"}
        ColorMask 0
        ZWrite off
        LOD 300
